...
Добро пожаловать в систему!!!";
            ...
            m:
                ...
                ResetColor();
                string a, b, c, d, e, login,log;//присваиваю значение логинов
                a = "Admin";
                b = "HR";
                c = "Sklad";
                d = "Buhgalter";
                e = "Manager";
                var us = new StreamReader(@"C:\Users\Пользователь\source\repos\Metadon1.1\Metadon1.1\bin\Debug\клиенты1.txt");
...
<<ВЫ АДМИН>>что бы выйти нажмите esc");
                string[] options1 = { "Помощь", "Редакировать пользователей", "Создать пользователя", "Удалить пользователя" };//массив значений в options для админа
