...
Добро пожаловать в систему!!!";
            ...
            h:
                ...
                p:
                    ...
                    g:
                        var rep = new StreamWriter(@"C:\Users\Пользователь\source\repos\Metadon1.2\Metadon1.2\bin\Debug\Клиенты", true);//система сохранения новых пользователей
                        ForegroundColor = ConsoleColor.Green;
            ...
            {
                string DefaultPath = @"C:\Users\Пользователь\source\repos\Metadon1.2\Metadon1.2\bin\Debug\Работники";
                ...
                while (true)
                {
                    ...
                    {
                        if (ObjWorkSheet.Cells[i, 1].Text == login)
                        {
                        
                           
                            string password =ReadLine() , inpt = string.Empty;
                            while (password != inpt)
                            {
                                ...
                                if (ObjWorkSheet.Cells[i, 2].Text == password)
                                {
                                    WriteLine("Пароль не верный\nПовторите пароль\nЕсли хотите вернуться в меню нажмите esc");
                                }
                        ...
                        else 
                        {
                            ...
                            ConsoleKeyInfo keyInfo9 = ReadKey(true);
                            keyPressed9 = keyInfo9.Key;
                            if (keyPressed9 == ConsoleKey.Escape)
                            {
                                Main(args);
                            }
                            ConsoleKey keyPressed8;
                            ConsoleKeyInfo keyInfo8 = ReadKey(true);
                            keyPressed8 = keyInfo8.Key;
                            if (keyPressed8 == ConsoleKey.Enter)
                            {
                                goto gf;
                            }
                        }
